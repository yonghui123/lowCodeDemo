<template>
  <div class="container">
    <h1 class="title font-weight-300 text-center">低代码平台问卷</h1>
    <!-- 按钮 -->
    <div class="mb-15">
      <el-button type="primary" :icon="Plus" @click="goToEdit">添加问卷</el-button>
      <el-button type="success" :icon="Compass" @click="goToMaterial">组件市场</el-button>
    </div>
    <!-- 问卷列表 -->
